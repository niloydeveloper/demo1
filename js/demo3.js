{
    ...
    class Slideshow {
        ...
        init() {
            ...
            this.DOM.nextCtrl = $('.slidenav__item--next');
            this.DOM.prevCtrl = $('.slidenav__item--prev');
            this.current = 0;
            this.createFrame(); 
            this.initEvents();
        }
        ...
        initEvents() {
            $('.slidenav__item--next').on('click', () => this.navigate('next'));
            $('.slidenav__item--next').on('click', () => this.navigate('prev'));
